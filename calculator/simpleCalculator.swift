...
final class SimpeCalculator {
    ...
    private var isPressedOperator = false // isOperatorPressed с точки англ более правильно; возможно симпатичнее будет сделать его вычисляемым проверять есть ли оператор в строке уже
    private var isPressedPointFirst = false
    private var isPressedPointSecond = false
